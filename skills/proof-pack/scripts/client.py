"""Small, amount-free client for the Proof Pack gateway product."""
...
def parser() -> argparse.ArgumentParser:
    command = SecretFreeArgumentParser(description="Client for the Proof Pack public-test result.")
